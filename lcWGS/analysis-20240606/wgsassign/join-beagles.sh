...
#SBATCH --output=/home/lspencer/pcod-lcwgs-2023/analysis-20240606/wgsassign2/err-out/join-beagles.txt
...
mkdir ${base}/wgsassign2/join-beagles-temp
temp=${base}/wgsassign2/join-beagles-temp
...
beagle1=${base}/reference/gls_wgassign/pcod-refs_wholegenome_wgassign_unlinked.beagle.gz
...
beagle2=${base}/experimental/gls_wgassign/pcod-exp_wholegenome_wgassign.beagle.gz
bamlist2=${base}/experimental/pcod-exp_filtered_bamslist.txt
prefix2=GM

# output and other settings
merged_beagle_name=wgsassign2/refs-exp-merged
