...
#SBATCH --output=/home/lspencer/pcod-lcwgs-2023/analysis-20240606/wgsassign2/err-out/snp-testing-subset-columns--beagle_all-locations.txt
...
cat ${base}/snp-testing/test_bams-list.txt | cut -f4,6 > ${base}/snp-testing/all-locations/test-IDs.txt
id_file="${base}/snp-testing/all-locations/test-IDs.txt"
