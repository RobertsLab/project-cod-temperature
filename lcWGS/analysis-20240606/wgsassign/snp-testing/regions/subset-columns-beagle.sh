...
#SBATCH --output=/home/lspencer/pcod-lcwgs-2023/analysis-20240606/wgsassign2/err-out/snp-testing-subset-beagle_regions.txt
...
cat ${base}/snp-testing/regions/test_bams-list_MR.txt | cut -f2,3 > ${base}/snp-testing/regions/test-IDs.txt
id_file="${base}/snp-testing/regions/test-IDs.txt"
output_beagle="${base}/snp-testing/regions/testing.beagle.gz"
