14.00-heatwave-genetics-trimmed-bwa-alignments
================
Sam White
2025-07-11
...
- <a href="#5-alignments" id="toc-5-alignments">5 ALIGNMENTS</a>
  - <a href="#51-create-bwa-index" id="toc-51-create-bwa-index">5.1 Create
    BWA Index</a>
  - <a href="#52-check-fastqs" id="toc-52-check-fastqs">5.2 Check FastQs</a>
  - <a href="#53-align-with-bwa" id="toc-53-align-with-bwa">5.3 Align with
    BWA</a>
- <a href="#6-mark-duplicates" id="toc-6-mark-duplicates">6 MARK
  DUPLICATES</a>
  - <a href="#61-set-read-groups" id="toc-61-set-read-groups">6.1 Set read
    groups</a>
  - <a href="#62-picard-markduplicates"
    id="toc-62-picard-markduplicates">6.2 Picard MarkDuplicates</a>
- <a href="#7-clip-overlaps" id="toc-7-clip-overlaps">7 CLIP OVERLAPS</a>
- <a href="#8-samtools-depth" id="toc-8-samtools-depth">8 SAMTOOLS
  DEPTH</a>
- <a href="#9-index-bams" id="toc-9-index-bams">9 INDEX BAMS</a>
- <a href="#10-stats-files" id="toc-10-stats-files">10 STATS FILES</a>
  - <a
    href="#101-multiqc-on-picard-markdduplicates-and-samtools-statsflagstat-files"
    id="toc-101-multiqc-on-picard-markdduplicates-and-samtools-statsflagstat-files">10.1
    MultiQC on Picard MarkdDuplicates and samtools stats/flagstat files</a>
- <a href="#11-references" id="toc-11-references">11 REFERENCES</a>
...
## 10.1 MultiQC on Picard MarkdDuplicates and samtools stats/flagstat files
