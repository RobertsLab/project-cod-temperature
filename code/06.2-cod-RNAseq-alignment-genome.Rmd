...
v NOT CURRENTLY WORKING v
```{r download-genome-gtf, engine='bash', eval=FALSE}
# Load bash variables into memory
source .bashvars
...
can use feature counts to get counts file (it an R package (?) that Laura and Steven use)
