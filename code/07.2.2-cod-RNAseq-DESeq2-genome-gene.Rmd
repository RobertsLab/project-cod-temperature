---
title: "07.2.2-cod-RNAseq-DESeq2genome-gene"
...
-   NOTE this analysis is for the featureCounts *genes* (see `06.2-cod-RNAseq-alignment-genome`)
...
write.table(cod_counts_data, file = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/Gmac_genome_gene_counts_formatted.tab", sep = "\t",
...
# Export PCAs as pngs
ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-PCA_L_500.png",
         plot   = p.L.500,
         res    = 600,
         width  = 6000,
         height = 4000)

ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-PCA_L_1000.png",
         plot   = p.L.1000,
         res    = 600,
         width  = 6000,
         height = 4000)

ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-PCA_L_all.png",
         plot   = p.L.all,
         res    = 600,
         width  = 6000,
         height = 4000)
...
write.table(sig_L.9.16_norm, file = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-Gmac_DEGs_sig_L.9.16_norm.tab", sep = "\t",
            row.names = TRUE, col.names = NA)
```
...
# Save plot
ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-heatmap_L.9.16_norm_sig.png",
         plot   = h.L.9.16,
         res    = 600,
         width  = 5000,
         height = 5000)
...
# Save plot
ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-volcano_L.9.16.png",
         plot   = v.L.9.16,
         res    = 600,
         width  = 6000,
         height = 4000)
...
write.table(sig_L.9.0_norm, file = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-Gmac_DEGs_sig_L.9.0_norm.tab", sep = "\t",
            row.names = TRUE, col.names = NA)
```
...
# Save plot
ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-heatmap_L.9.0_norm_sig.png",
         plot   = h.L.9.0,
         res    = 600,
         width  = 5000,
         height = 5000)
...
# Save plot
ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-volcano_L.9.0.png",
         plot   = v.L.9.0,
         res    = 600,
         width  = 6000,
         height = 4000)
...
write.table(sig_L.9.5_norm, file = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-Gmac_DEGs_sig_L.9.5_norm.tab", sep = "\t",
            row.names = TRUE, col.names = NA)
```
...
# Save plot
ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-heatmap_L.9.5_norm_sig.png",
         plot   = h.L.9.5,
         res    = 600,
         width  = 5000,
         height = 5000)
...
# Save plot
ggexport(filename = "../output/07.2.2-cod-RNAseq-DESeq2genome-gene/gene-volcano_L.9.5.png",
         plot   = v.L.9.0,
         res    = 600,
         width  = 6000,
         height = 4000)
