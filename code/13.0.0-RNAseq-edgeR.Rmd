...
# Print the modified header and the matrix to verify
...
gene_count_matrix <- as.matrix(read.csv("../output/10.1-hisat-deseq2/gene_count_matrix.csv", row.names="gene_id"))
